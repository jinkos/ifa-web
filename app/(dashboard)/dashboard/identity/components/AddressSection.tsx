...
export default function AddressSection({
  ...
  return (
    <FormSection title="Address">
      <FormGrid colsMd={2}>
        <Field id="address1" label="Address line 1" fieldName="Identity — Address line 1" showShoppingAction incoming={typeof suggestions?.address1 !== 'undefined' ? { value: suggestions?.address1 ?? '', onAccept: () => onAccept?.('address1'), onReject: () => onReject?.('address1') } : undefined}>
        ...
        <Field id="address2" label="Address line 2" fieldName="Identity — Address line 2" showShoppingAction incoming={typeof suggestions?.address2 !== 'undefined' ? { value: suggestions?.address2 ?? '', onAccept: () => onAccept?.('address2'), onReject: () => onReject?.('address2') } : undefined}>
        ...
        <Field id="city" label="City" fieldName="Identity — City" showShoppingAction incoming={typeof suggestions?.city !== 'undefined' ? { value: suggestions?.city ?? '', onAccept: () => onAccept?.('city'), onReject: () => onReject?.('city') } : undefined}>
        ...
        <Field id="postcode" label="Postcode" fieldName="Identity — Postcode" showShoppingAction incoming={typeof suggestions?.postcode !== 'undefined' ? { value: suggestions?.postcode ?? '', onAccept: () => onAccept?.('postcode'), onReject: () => onReject?.('postcode') } : undefined}>
